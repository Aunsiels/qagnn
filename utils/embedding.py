...
if __name__ == "__main__":
    glove2npy(glove_path='../../OpenKE/transe_ascent.txt', output_npy_path='../data/cpnet/nb.npy', output_vocab_path='../data/cpnet/nb.vocab', skip_head=True)
    load_pretrained_embeddings(glove_npy_path='../data/cpnet/nb.npy', glove_vocab_path='../data/cpnet/nb.vocab', vocab_path='../data/cpnet/concept.txt', save_path='../data/cpnet/concept.nb.npy')
